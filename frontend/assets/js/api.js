...
const API = {
  ...
  async getAttacheeAttendanceSummary(attacheeId) {
    const response = await fetch(`${API_BASE_URL}/attendance/summary/${attacheeId}`, {
      headers: getHeaders(),
    });
    return handleResponse(response);
  },
  ...
  async getLogbookEntries(params = {}) {
    const query = new URLSearchParams(params).toString();
    const response = await fetch(`${API_BASE_URL}/logbook?${query}`, {
      headers: getHeaders(),
    });
    return handleResponse(response);
  },
  ...
  async submitLogbookEntry(id) {
    const response = await fetch(`${API_BASE_URL}/logbook/${id}/submit`, {
      method: 'PUT',
      headers: getHeaders(),
    });
    return handleResponse(response);
  ...
  async reviewLogbookEntry(id, data) {
    const response = await fetch(`${API_BASE_URL}/logbook/${id}/review`, {
      method: 'PUT',
      headers: getHeaders(),
      body: JSON.stringify(data),
    });
  ...
  async getLogbookSummary(attacheeId) {
    const response = await fetch(`${API_BASE_URL}/logbook/summary/${attacheeId}`, {
      headers: getHeaders(),
    });
    return handleResponse(response);
  },
  ...
  async getAttendanceReport(params = {}) {
    const query = new URLSearchParams(params).toString();
    const response = await fetch(`${API_BASE_URL}/reports/attendance?${query}`, {
      headers: getHeaders(),
    });
    return handleResponse(response);
  },
  ...
  async getEvaluationReport() {
    const response = await fetch(`${API_BASE_URL}/reports/evaluations`, {
      headers: getHeaders(),
    });
    return handleResponse(response);
  },
